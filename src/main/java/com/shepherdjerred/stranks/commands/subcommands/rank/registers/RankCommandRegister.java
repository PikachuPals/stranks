...
public class RankCommandRegister extends CommandRegister {

    private final Ranks ranks;
    private final RankPlayerController rankPlayerController;
    private final RankPlayers rankPlayers;

    public RankCommandRegister(AbstractParser parser, Ranks ranks, RankPlayerController rankPlayerController, RankPlayers rankPlayers) {
        super(parser);
        this.ranks = ranks;
